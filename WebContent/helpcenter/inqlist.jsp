                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="field"><select name="inqSubType" id="" class="commonSelectbox">
                                                                <option value="" disabled="">카테고리 선택</option>
                                                                   <option value="ICA0100">회원가입</option>
                                                                   <option value="ICA0200">탈퇴</option>
                                                                   <option value="ICA0300">회원정보수정</option>
                                                                   <option value="ICA0600">상품</option>
                                                                   <option value="ICA0700">전문판매자</option>
                                                                   <option value="ICA0400">기타</option>
                                                                   <option value="IDA0100">직거래 피해신고</option>
                                                                   <option value="IBA0100">헬로마켓 편의점택배</option>
                                                                   <option value="IBA0200">헬로마켓 방문택배</option>
                                                                   <option value="IBA0400">용달/퀵</option>
                                                                   <option value="IBA0300">기타</option>
                                                                   <option value="IEA0700">회원가입</option>
                                                                   <option value="IEA0100">아이템등록</option>
                                                                   <option value="IEA0800">동영상</option>
                                                                   <option value="IEA0200">헬로페이</option>
                                                                   <option value="IEA0300">배송</option>
                                                                   <option value="IEA0400">헬로톡</option>
                                                                   <option value="IEA0500">알림</option>
                                                                   <option value="IEA0900">검색</option>
                                                                   <option value="IEA0600">기타</option>
                                                                   <option value="IIA0700">일반 이용문의</option>
                                                                   <option value="IIA0200">스마트직거래 서비스</option>
                                                                   <option value="IIA0100">해외판매 서비스</option>
                                                                   <option value="IIA0800">기타 문의</option>
                                                                   <option value="IIB0100">일반 이용문의</option>
                                                                   <option value="IIB0200">딜러신청/취소</option>
                                                                   <option value="IIB0300">멤버십 이용권</option>
                                                                   <option value="IIB0500">경매차량 매입</option>
                                                                   <option value="IIB0400">기타 문의</option>
                                                                   <option value="IJA0600">전체 광고</option>
                                                                   <option value="IJA0100">배너 광고</option>
                                                                   <option value="IJA0800">회원직접 광고</option>
                                                                   <option value="IJA0900">유료 상단업</option>
                                                                   <option value="IJA0200">기타</option>
                                                                   <option value="IFA0100">제안하기</option>
                                                                   <option value="IGA0100">기타</option>
                                                                   <option value="IGA0200">제휴문의</option>
                                                            </select></td>
                                                    </tr>
                                                    <tr>

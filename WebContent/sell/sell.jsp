...
<body>
 <%
   ...
   if(request.getParameter("pIdx")!=null){
	   ...
	   board = boardDAO.showThisItem(pIdx);
                  ...
                  <dd>
                    <ul class="item_status_list">
                      <li class="item_status">
                          ...
                          <div style="font-size:13px" class="text"> <input type="checkbox" id="p_status1" name="p_status1" value="새상품" checked>새상품</div>
                      ...
                      <li class="item_status">
                          ...
                          <div style="font-size:12px" class="text"><input type="checkbox"  id="p_status2" name="p_status2" value="중고">중고</div>
                      ...
                      <dd>
                        <div class="box_option box_area check_box_area">
                          ...
                          <div class="can_barter_check can_delivery_check"><label
                              class="feature_option feature_option_checkbox no_feature_option"><input type="checkbox" name="p_exchange" value="교환신청">교환신청</label></div>
                        </div>
                      </dd>
                    </dl>
                  </dd>
          ...
          <div class="main">
            ...
            <div class="regist_box">
              <div class="description">
                ...
                <dl class="regist_image_dl" id="registImage">
                  <dt><label style="color:#333333">상품사진</label><span class="photo_max"></span></dt>
                  <dd>
                    <ul class="image_list">
                        <li>
                          <div class="up_img_box" id="">
                  ...
                  <dd>
                    <ul class="item_status_list">
                      ...
                      <li class="item_status">
                          ...
                          <div style="font-size:12px" class="text"><input type="radio"  id="p_status1" name="p_status1" value="중고">중고</div>
